...
public class GphoneCutie {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GphoneCutie window = new GphoneCutie();
	...
	private void initialize() {
		...
		ImageIcon gApplemini = new ImageIcon("gimages/GphoneCutie.jpg");
		...
		gphoneCutie.setBounds(12, 5, 300, 300);
		panel.add(gphoneCutie);
		
		String [] colors = {"choose the color","Space Gray","Emerald Green","Bad Red"}; 
		...
		JLabel nameLabel = new JLabel("G-Phone 13 Cutie ");
